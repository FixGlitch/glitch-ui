...
const DialogSeparator = ({
  ...
  <hr className={cn("border-t border-gray-200 my-4", className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex justify-center items-center p-4 bg-blue-100 rounded-full",
      className
    )}
    {...props}
  />
...
const DialogSubHeader = React.forwardRef<
  React.ElementRef<"p">,
